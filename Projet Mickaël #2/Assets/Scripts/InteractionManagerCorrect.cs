...
public class InteractionManagerCorrect : MonoBehaviour
{
    ...
    void GetMouseScreenPos()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (hit.transform.GetComponent<InteractableObject>() != null) //Si l'objet touché a le script "DoorBadExample"
                {
