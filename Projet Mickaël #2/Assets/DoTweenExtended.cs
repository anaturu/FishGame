...
namespace DG.Tweening
{
    public static class DOTweenExtended
    {
        ...
        public static TweenerCore<float, float, FloatOptions> DOSphereColliderRadius(this SphereCollider target, float endValue, float duration)
        {
            TweenerCore<float, float, FloatOptions> t = DOTween.To(() => target.radius, x => target.radius = x, endValue, duration);
            t.SetTarget(target);
            return t;
        ...
        public static TweenerCore<float, float, FloatOptions> DOChromaticAberrationIntensity(this ChromaticAberration target, float endValue, float duration)
        {
            TweenerCore<float, float, FloatOptions> t = DOTween.To(() => target.intensity.value, 
                x => target.intensity.value = x, endValue, duration);
            t.SetTarget(target);
            return t;
        }
        ...
        public static TweenerCore<float, float, FloatOptions> DOLensDistortion(this LensDistortion target, float endValue, float duration)
        {
            TweenerCore<float, float, FloatOptions> t = DOTween.To(() => target.intensity.value, 
                x => target.intensity.value = x, endValue, duration);
            t.SetTarget(target);
